      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <section className={styles.section}>
            ...
            <p>
              By booking an appointment or using any services at Serenity Spa Malaysia, you agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our services.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.subsection}>
              ...
              <ul>
                <li>All bookings must be made by individuals 18 years or older</li>
            ...
            <div className={styles.subsection}>
              ...
              <ul>
                <li>Full payment is required at the time of service unless otherwise arranged</li>
                <li>We accept cash, credit cards, and digital payments</li>
                <li>Gift certificates and promotional codes have specific terms and expiry dates</li>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.subsection}>
              ...
              <ul>
                <li>Clients must disclose any health conditions, allergies, or medications</li>
                <li>Pregnant clients must inform us and may have restricted service options</li>
                <li>We reserve the right to refuse service if health conditions pose risks</li>
                <li>Medical clearance may be required for certain treatments</li>
              </ul>
            </div>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.subsection}>
              ...
              <ul>
                <li>Maintain respectful behavior towards staff and other clients</li>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.subsection}>
              ...
              <ul>
                <li>Serenity Spa is not responsible for lost or stolen personal items</li>
          ...
          <section className={styles.section}>
            ...
            <p>
              Your privacy is important to us. Please refer to our <a href="/privacy" className={styles.link}>Privacy Policy</a> for detailed information about how we collect, use, and protect your personal information.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <p>
              All content, including but not limited to text, images, logos, and treatment descriptions, is the intellectual property of Serenity Spa Malaysia and is protected by copyright laws.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <p>
              We reserve the right to modify these terms at any time. Changes will be posted on our website and will take effect immediately upon posting. Continued use of our services constitutes acceptance of modified terms.
            </p>
          </section>
